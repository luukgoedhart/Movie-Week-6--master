package com.example.movieweek6.movieModel;
...
public class MostPopularMoviesAdapter extends RecyclerView.Adapter<MostPopularMoviesAdapter.ViewHolder> {
    ...
    public MostPopularMoviesAdapter(List<Movie> movies, MovieListener movieListener) {
        this.movies = movies;
    ...
    @NonNull
    @Override
    public MostPopularMoviesAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder viewHolder, int i) {
        ...
        new DownloadImageTask(viewHolder.moviePoster).execute(movie.getPosterPath());
    }
